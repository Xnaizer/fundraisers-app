  ...
  <div className="bg-black/40 min-h-screen w-full fixed z-50 inset-0 flex items-start sm:items-center justify-center p-2 sm:p-4 md:p-6 lg:p-8">
    <div
      className="bg-black text-white w-full 
        max-w-[96%] xs:max-w-[94%] 
        sm:max-w-[85%] md:max-w-[75%] 
        lg:max-w-[80%] xl:max-w-[75%] 2xl:max-w-[70%] 
        rounded-lg sm:rounded-xl md:rounded-2xl 
        mt-20 xs:mt-16 sm:mt-20 md:mt-24   
        relative shadow-lg overflow-hidden 
        max-h-[85vh] xs:max-h-[88vh] sm:max-h-[85vh] md:max-h-[90vh] lg:max-h-[85vh]
        overflow-y-auto"
